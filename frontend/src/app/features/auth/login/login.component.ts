    ...
    <div class="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8">
      <div class="w-full max-w-md space-y-8 rounded-3xl border border-slate-200 bg-white p-10 shadow-xl">
        <div class="text-center">
          <h2 class="text-3xl font-bold tracking-tight text-slate-900">AI Discord Ops</h2>
          <p class="mt-2 text-sm text-slate-600">Connect your Discord account to get started</p>
        </div>
        
        <div class="mt-8">
          <button
            (click)="onLogin()"
            class="flex w-full items-center justify-center gap-3 rounded-xl bg-[#5865F2] px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-[#4752C4] focus:outline-none focus:ring-2 focus:ring-[#5865F2] focus:ring-offset-2"
          >
